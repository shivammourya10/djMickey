...
// const IMGS = [
//   {
//     avif: "/assets/Blue_motionblur.avif",
//     webp: "/assets/Blue_motionblur.webp",
//     fallback: "/assets/Blue_motionblur.jpg",
//   },
//   {
//     avif: "/assets/Brown_jacket_pink_bg.avif",
//     webp: "/assets/Brown_jacket_pink_bg.webp",
//     fallback: "/assets/Brown_jacket_pink_bg.jpg",
//   },
//   {
//     avif: "/assets/white_red_jacket.avif",
//     webp: "/assets/white_red_jacket.webp",
//     fallback: "/assets/white_red_jacket.jpg",
//   },
//   // Add more images with WebP/AVIF/fallback URLs...
// ];

// const VerticalGalleryTextComponent = () => (
//   <div className="absolute left-2 top-1/6 flex flex-col items-center mt-10 z-10">
//     <span className="mb-5 text-lg text-gray-400 font-bold tracking-widest rotate-270">IMAGE GALLERY</span>
//     <motion.div
//       initial={{ height: 10 }}
//       animate={{ height: 400 }}
//       transition={{ duration: 5 }}
...
//   useEffect(() => {
//     const handleResize = debounce(() => setIsScreenSizeSm(window.innerWidth <= 640), 100);
//     window.addEventListener("resize", handleResize);
//     return () => window.removeEventListener("resize", handleResize);
//   }, []);
...
//   const faceWidth = useMemo(() => (cylinderWidth / faceCount) * 1.15, [cylinderWidth, faceCount]);
...
//                     alt="gallery"
//                     loading="lazy"
//                     className="pointer-events-none h-[280px] w-[550px] rounded-[15px] border-[3px] border-white object-cover transition-transform duration-300 ease-out group-hover:scale-110 sm:h-[220px] sm:w-[450px]"
//                   />
//                 </picture>
//               </LazyLoad>
//             </div>
